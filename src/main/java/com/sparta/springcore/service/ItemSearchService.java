...
public class ItemSearchService {
    ...
    public List<ItemDto> searchItems(String query) throws IOException {

        RestTemplate rest = new RestTemplate();
        HttpHeaders headers = new HttpHeaders();
        headers.add("X-Naver-Client-Id", "YhGDVSRN8cGNYdNRJmqY"); // zdqMoIkFaK8uKvC2oNY2
        headers.add("X-Naver-Client-Secret", "TBGQ5JUiT4"); // LiZfsgtuD5
        String body = "";
